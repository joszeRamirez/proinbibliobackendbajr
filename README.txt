...
a persistence unit "bibliotecabajrPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "bibliotecabajr/pom.xml":
...
artifact ("bibliotecabajr.war") is already built. You can build
